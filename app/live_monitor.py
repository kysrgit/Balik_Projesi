...
def main():
    ...
    while True:
        ...
        if len(boxes) > 0:
            ...
            # Draw Alarm
            cv2.rectangle(display_frame, (0, 0), (width, height), (0, 0, 255), 20)
            cv2.putText(display_frame, "WARNING: PUFFERFISH DETECTED", (50, height // 2), 
        ...
        cv2.imshow("ROV Control Screen - Live Monitor", display_frame)
